...
export async function analyzeRowVideo(
	...
	const prompt = [
		...
		'',
		'IMPORTANT: Only count actual grapevines. Vineyard rows contain tall (~2m) wooden posts that hold guide wires — these are infrastructure, not vines. Do not count them.',
		'Young vines are often protected by a green plastic cylinder (grow tube) — these ARE vines and should be counted.',
		'',
